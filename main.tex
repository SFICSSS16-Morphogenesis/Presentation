...
%$\rightarrow$ Metaphor to conceptualize social change and of the subject within it and processes like the relation to evolution of human cultural behavior and learning.

%$\rightarrow$ Morphogenetic phenomena related to the structure of the neural nets and “hardware” of the brain

%$\rightarrow$ in Clinical psychology and psychopathology analogies to understand the emergence of psychical structures (Neurosis, Psychosis, etc) and the self-organization of relational forms (the self and the other), the formation of the symptom and of the transference-countertransference matrix. 

%$\rightarrow$ Formation in early stages of development, but continue to repeat and influence behavior all throughout a subject’s life.

% add picture

\footnotesize

$\rightarrow$ A very powerful metaphor to conceptualize social change and the subject within it and processes like the relation to evolution of human cultural behavior and learning.

$\rightarrow$ Useful in fields like: Neuroscience ; Evolutionary Psychology ; Social Psychology ; Clinical Psychology ; Psychopathology ; Psychoanalysis


\textbf{Examples :}
\begin{itemize}
\item \footnotesize
Emergence of Psychical structures (Neurosis, Psychosis, etc) 
\item \footnotesize
Self-organization of relational forms (the self and the other)
\item \footnotesize
...
\begin{center}
\includegraphics[height=0.5\textheight]{figures/psycho}
\end{center}
...
\cite{bourgine2004autopoiesis} ; co-evolution of subsystems as an alternative definition ?
\end{itemize}
...
\textbf{Hierarchical imbrication of concepts : }
...
\textbf{Application : } An ontological~\cite{livet2010ontology} specification yield a particular application 
(\textit{inclusions and properties depends on disciplines}), but no direct equivalence of projected concepts~\cite{bourgine2010morphogenesis}
...
$\rightarrow$ Main result for now : discrepancy of the concept across disciplines

\bigskip

$\rightarrow$ Systematize the framework : iterative construction ; systematic comparison / update of concepts

\bigskip

$\rightarrow$ Application to a concrete case to implement effective interdisciplinary transfer
...
$\rightarrow$ Algorithmic Literature Review and Text-mining complementary to the qualitative approach ; look for disciplinary proximity and level of interdisciplinarity
